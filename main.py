...
parser.add_argument('--size-x', default=256, type=int, help="width of sliding window in data augmentation, default 256")
parser.add_argument('--size-y', default=256, type=int, help="height of sliding window in data augmentation, default 256")
