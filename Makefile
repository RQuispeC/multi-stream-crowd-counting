...
test-ucf-fold1: #test fold 1 of ucf-cc-50 dataset
	$(run_ucf) --units ucf-fold1 --save-dir log/multi-stream --resume log/multi-stream/ucf-cc-50_people_thr_0_gt_mode_same/ --evaluate-only 
test-ucf-fold2: #test fold 2 of ucf-cc-50 dataset
	$(run_ucf) --units ucf-fold2 --save-dir log/multi-stream --resume log/multi-stream/ucf-cc-50_people_thr_0_gt_mode_same/ --evaluate-only 
test-ucf-fold3: #test fold 3 of ucf-cc-50 dataset
	$(run_ucf) --units ucf-fold3 --save-dir log/multi-stream --resume log/multi-stream/ucf-cc-50_people_thr_0_gt_mode_same/ --evaluate-only 
test-ucf-fold4: #test fold 4 of ucf-cc-50 dataset
	$(run_ucf) --units ucf-fold4 --save-dir log/multi-stream --resume log/multi-stream/ucf-cc-50_people_thr_0_gt_mode_same/ --evaluate-only 
test-ucf-fold5: #test fold 5 of ucf-cc-50 dataset
	$(run_ucf) --units ucf-fold5 --save-dir log/multi-stream --resume log/multi-stream/ucf-cc-50_people_thr_0_gt_mode_same/ --evaluate-only
...
test-shanghai-partA: #test part A of Shanghai Tech dataset
	$(run_shanghai) --units shanghai-partA --save-dir log/multi-stream --resume log/multi-stream/shanghai-tech_people_thr_0_gt_mode_same/ --evaluate-only
test-shanghai-partB: #test part B of Shanghai Tech dataset 
	$(run_shanghai) --units shanghai-partB --save-dir log/multi-stream --resume log/multi-stream/shanghai-tech_people_thr_0_gt_mode_same/ --evaluate-only
